This NMF script performs Non-negative Matrix Factorization (NMF) on RNA-Seq gene expression data to identify molecular clusters (subtypes) of patients and genes. 
